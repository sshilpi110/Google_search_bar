...
const data = [
  ...
  function display(data) {
    ...
    p.innerText ="country : " + data.countryName;
    let p1 = document.createElement("p");
    p1.innerText ="Short Code : " + data.countryShortCode;
    let p2 = document.createElement("p");
    p2.innerText="Regions:"
    div.append(p,p1,p2);
    data.regions.map(e=>{
      let p3 = document.createElement("p");
      p3.innerText ="Name- " +e.name;
      let p4 = document.createElement("p");
      p4.innerText ="Name- "+ e.shortCode;
      div.append(p3)
    })
  ...
  function append(data) {
    ...
    if (data.length > 5) {
      suggBox.style.overflowY = "scroll";
    } else {
      suggBox.style.overflow = "hidden";
    }
